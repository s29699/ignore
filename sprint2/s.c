...
void * doNetworking(void * ClientDetail){
	...
	while(1){
		...
		if(strcmp(data,"QUERY") == 0){
			// Respond to QUERY with dummy messages
			snprintf(output, 1024, "This is a dummy response to your query.\n");
			
			snprintf(output, 1024, "Type 1:one 2:two 3:three 4:four 5:five \n");
